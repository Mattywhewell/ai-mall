...
CREATE TABLE IF NOT EXISTS user_subscriptions (
  ...
  preferences JSONB DEFAULT '{}'::jsonb, -- {preferred_districts: [], avoid_categories: [], intensity_level: 'medium'}
  ai_profile JSONB DEFAULT '{}'::jsonb, -- AI learns preferences over time
  total_boxes_received INTEGER DEFAULT 0,
  satisfaction_score DECIMAL(3,2) DEFAULT 5.0, -- User rates each box
...
ALTER TABLE user_subscriptions ADD COLUMN IF NOT EXISTS tier_id UUID REFERENCES subscription_tiers(id) ON DELETE CASCADE;
...
-- Subscription Boxes (Monthly themed collections)
...
((SELECT id FROM subscription_boxes WHERE slug = 'winter-solstice-2026'),
 ...
 'Created by an herbalist on Wellness Way who wild-harvests ingredients under specific moon phases.',
 'Burn to cleanse space and invite clarity before ritual work',
 'Pine for purification, sage for wisdom and protection',
 2),
((SELECT id FROM subscription_boxes WHERE slug = 'winter-solstice-2026'),
 'Solstice Beeswax Candle',
 'Pure beeswax pillar candle with embedded herbs',
 'ritual_object', 1, 28.00, 'artisan-row',
 'Made by a third-generation candle maker who infuses each with seasonal herbs and intention.',
