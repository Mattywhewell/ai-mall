...
-- Layered spaces: Halls â†’ Streets â†’ Districts, with Chapels as intimate spaces
...
('Sanctuary of Joy', 'sanctuary-joy', 'joy', 'Laughter echoes through these walls like music. Here, happiness is not pursuedâ€”it simply is.', ARRAY['celebration', 'light', 'gratitude'], 'Joy shared multiplies infinitely.', (SELECT id FROM halls WHERE slug = 'kinetic-plaza')),
...
('Haven of Serenity', 'haven-serenity', 'serenity', 'Peace flows like water over stones. Time moves differently hereâ€”gentle, unhurried, eternal.', ARRAY['peace', 'tranquility', 'balance'], 'Serenity is found within, not without.', (SELECT id FROM halls WHERE slug = 'garden-serenity'))
ON CONFLICT (slug) DO NOTHING;
