...
import { MapPin, Users, ShoppingBag, Home, RotateCcw, Navigation } from 'lucide-react';
...
export function NavigationControls({ mode, onModeChange, onHomeClick }: NavigationControlsProps) {
  return (
