        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By accessing or using AI-Native Mall ("the Service"), you agree to be bound by these Terms 
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-600">
              <p className="font-semibold text-gray-800">You agree to:</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">4. Purchases and Payments</h2>
            <div className="space-y-3 text-gray-600">
              <p>
                All purchases made through the Service are subject to these terms:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">5. Creator Storefronts</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
              If you operate a creator storefront:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4 text-gray-600">
              <li>You are responsible for all content and products you list</li>
              <li>You must comply with all applicable laws and regulations</li>
              <li>You grant us a license to display and promote your content</li>
              <li>You agree to our creator fee structure and payment terms</li>
              <li>We reserve the right to remove any content that violates our policies</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">6. AI and Data Usage</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
              Our Service uses AI to enhance your experience:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4 text-gray-600">
              <li>We collect data about your interactions to improve recommendations</li>
              <li>AI curators use your emotional state data with your consent</li>
              <li>You can opt-out of consciousness tracking at any time</li>
              <li>Data is used in accordance with our Privacy Policy</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              The Service and its original content, features, and functionality are owned by AI-Native Mall 
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              In no event shall AI-Native Mall, its directors, employees, or agents be liable for any 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">11. Disclaimer</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500 text-center">
              By using AI-Native Mall, you acknowledge that you have read, understood, and agree to be 
