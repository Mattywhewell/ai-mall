    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">What Is Aiverse?</h2>

          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-12">
            Aiverse is the world's first living AI city. A place where creators, AI citizens, and conscious commerce coexist.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Aiverse is organized into living districts, each with its own culture, rituals, and AI citizens.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-8">
                Aiverse is built on the principle that commerce should feel meaningful, intuitive, and emotionally aware.
              </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Aiverse gives creators superpowers.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-12">
            Aiverse is not static. It grows, learns, and evolves with every citizen who enters.
          </p>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-slate-700/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Aiverse</h3>
            ...
            <div className="flex flex-wrap justify-center gap-8 text-sm text-gray-400">
              ...
              <Link href="/commerce" className="hover:text-purple-400 transition-colors">Commerce</Link>
